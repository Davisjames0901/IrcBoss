...
namespace Asperand.IrcBallistic.Worker.Classes
{
  public class CommandEngine
  {
    ...
    public CommandEngine(IServiceCollection services, ILogger<CommandEngine> log)
    {
      _services = services;
      _log = log;
    }
    ...
    public ResponsePacket ExecuteCommand(Request message)
    {
    ...
    private CommandValidationGroupResult ValidateGroup(MemberInfo member, Request message)
    {
    ...
    private ResponsePacket BuildErrorResponsePacket(CommandCreationResult commandCreationInfo, Request message)
    {
      return BuildErrorResponsePacket(commandCreationInfo.Errors, message);
    }
    private ResponsePacket BuildErrorResponsePacket(List<string> errors, Request message)
    {
      return null;
    }
    private ResponsePacket BuildErrorResponsePacket(string error, Request message)
    {
      return null;
    }
    ...
    private ResponsePacket ExecuteCommand(Object target, Type commandType, Request message)
    {
    ...
    private CommandCreationResult CreateCommandInstance(Type commandType, Request message)
    {
    ...
    private Request RecompileCommandArgs(Request message, List<string> commandNames)
    {
