...
//       PrefixCommands.Add("lsusr", new Command("Lists the users and their permissions", (x, y, z) => string.Join("; ",z.Permissions.Select(u=> $"{u.Key}: {u.Value}"))));
...
//     {
//       user = user.ToLower();
//       if (connection.Permissions.ContainsKey(user))
//       {
//         return "User is already added.";
//       }
//       connection.Permissions.Add(user, role);
...
//         return $"?mock {user}";
//       }
//       if (connection.Permissions.ContainsKey(args))
//       {
